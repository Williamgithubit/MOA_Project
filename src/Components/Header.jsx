      ...
      <div className=" w-full px-6 py-4 border h-36">
        <div className="parent w-full flex">
          <div className="w-[40%] flex gap-2">
            <img src={logo} alt="MOA Logo" width="20%" />
            <div className="w-2/3">
          ...
          <div className="search-bar w-[70%]">
            <input className="border-none mr-5 outline-none p-2 w-3/4 ring-1 ring-gray-500 rounded" type="search" name="" id="" autoComplete="off" placeholder="Search for tenders, contracts, or vendors"/>
            <button type="submit" className="backdrop-blur-sm hover:backdrop-blur-lg ring-1 rounded font-medium hover:bg-green-900 hover:text-white ring-gray-500 py-2 px-8 hover:bg-green-600 transition-all">Register</button>
